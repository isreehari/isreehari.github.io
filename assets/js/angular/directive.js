(function (angular) {
      ...
      // constants
          return {
                  ...
                  link: function (scope, element, attrs) {
                        ...
                        scope.$watch('relationshipData', function (newVal, oldVal){
                          ...
                          var d = d3.select(element[0]).append("svg").attr("width", a).attr("height", c).append("g").attr("transform", "translate(" + a / 2 + "," + c / 2 + ")");
                        ...
                        //  d3.json("data/concept-map.json", function(X, Y) {
                          ...
                          function O() {
                              ...
                              A.forEach(function(af, ag) {
                                  ...
                                  var a2 = (ag[1].x - 90) * Math.PI / 180, bulge = 20;
                                  P.push({
    ...
    angular
        ...
        .directive('relationshipGraph', [relationshipGraph])
})(window.angular);
